...
public class ProductType extends Model<ProductType> {
    ...
    /**
     * @Author: Panda
     * @Description: treeDate 的老子数据！
     * @Date: Administrator  * @param null :  12:59  * @return : null 2019/5/10
     */
    @TableField(exist = false)
    private ProductType parent;                                            //老子
    /**
     * @Author: Panda
     * @Description: treeDate 的儿子数据！
     * @Date: Administrator  * @param null :  13:00  * @return : null 2019/5/10
     */
    @TableField(exist = false)
